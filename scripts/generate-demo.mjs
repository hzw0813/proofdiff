...
const scenarios = [
  {
    ...
    description: "A related JavaScript test file is explicitly executed successfully; a Python retry change has no applicable verification.",
...
function gallery(results) {
  ...
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="dark"><meta name="description" content="A real ProofDiff demo showing which statically related test files were explicitly run—and which were not observed."><link rel="icon" href="data:"><title>ProofDiff · Which related tests actually ran?</title><style>
  ${heroLinkStyle}
