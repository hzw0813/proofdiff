...
- Two independent `npm pack` runs produced byte-identical 54,281-byte tarballs with SHA-256 `bd3b3e075790885ce6d2ec41b11ad1e7de662e39369881b46f0d4220ad8d1ea6`.
...
- The first GitHub-hosted run passed Linux and macOS across Node.js 22, 24, and 26, plus both Action smoke jobs. Windows exposed a Git null-device incompatibility; the focused fix has local regression coverage and still awaits a complete hosted rerun.
...
- The Windows null-device fix has not yet passed on a Windows host.
