...
| --- | --- | --- | --- |
| Mixed evidence | JavaScript discount validation plus a Python retry loop | One qualified related target pass (`verified` in JSON), one unverified file; overall partial | Demonstrates transitive dependency impact, a positive file-scoped target observation, and honest missing Python evidence. |
